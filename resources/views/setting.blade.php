                    ...
                    <fieldset class="mt-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" name="account[email]"
                             id="email" value="{{ old('account.email', $user->email) }}" class="form-control @error('account.email') is-invalid @enderror">
                             @error('account.email')
                                <div class="invalid-feedback">{{ $message }}</div>
                             @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="password" name="account[password]"
                             id="password" class="form-control @error('account.password') is-invalid @enderror">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" name="account[new_password]"
                             id="new_password" class="form-control @error('account.new_password') is-invalid @enderror">
